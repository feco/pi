...
constraints, acceptance criteria, and required evidence. For substantial
mutation work, pass an explicit native acceptance policy: concrete criteria;
`changed-files`, `tests-added`,
`commands-run`, `residual-risks`, and `no-staged-files` evidence as applicable;
and project-specific host-run verification commands. Require an independent
...
- Main: /var/home/goulven/.local/share/pi-node/node-v22.22.3-linux-x64/lib/node_modules/@earendil-works/pi-coding-agent/README.md
- Docs:  .../pi-coding-agent/docs   (extensions.md, themes.md, skills.md, tui.md, keybindings.md, sdk.md, models.md, packages.md, prompt-templates.md, custom-provider.md)
- Examples: .../pi-coding-agent/examples
Read the relevant .md fully and follow cross-references before implementing. Resolve
`docs/...` and `examples/...` against the paths above, not the working directory.
</pi_documentation>
